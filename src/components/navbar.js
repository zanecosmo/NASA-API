...
const Navbar = () => {
    return (
        <div className={styles["navbar"]}>
            ...
            <div className={styles["navbar-background-01"]}>
                ...
                <div className={styles["page-title"]}>NASA API</div>
            </div>

            <div className={styles["navbar-background-02"]}></div>
            <div className={styles["navbar-background-03"]}></div>
            <div className={styles["navbar-background-04"]}></div>

            <div className={styles["button-container"]}>
                <div className={styles["navbar-button"]}>APOD</div>
                <div className={styles["navbar-button"]}>Martian Weather</div>
                <div className={styles["navbar-button"]}>Rover Photos</div>
                <div className={styles["navbar-button"]}>Earth Photos</div>
            </div>
